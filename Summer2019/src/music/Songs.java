...
// Measure 51
			...
			addNotes("F4s A4s C5s A4s C5s A4s",T);
...
// Measure 82
			...
			addNote("A5i",A,T);
			addRest("i",2,T);
			addNotes("A3i A3i A3i A3i A3i A3i",B);
...
// Measure 88
			...
			addNotes("C5q+F#5q+A5s C5i+A5i",T);
...
// Measure 97
			...
			addNotes("Bn3q Bn3q Bn3q Bn3q Bn3q Bn3q",B);
